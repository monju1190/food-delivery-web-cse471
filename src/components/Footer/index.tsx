      ...
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 md:text-xl">
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://github.com/monju1190"
          ...
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://www.linkedin.com/in/monjur-ahmed-a8490722b/"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsLinkedin />
          </motion.a>
          ...
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://www.instagram.com/monju19____/"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsInstagram />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://www.facebook.com/monjur.ahmed.336717"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsFacebook />
          </motion.a>
